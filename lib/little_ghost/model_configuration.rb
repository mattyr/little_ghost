  ...
  class ModelConfiguration
    ...
    def validate!
      ...
      models.each do |name, profile|
        ...
        target = ModelTarget.parse(profile.fetch("target") { raise ConfigurationError, "models.yml: models.#{name}.target is required" })
      ...
      ModelTarget.parse(default_model) if default_model.include?(":")
    end
  end
end
